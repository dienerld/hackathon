...
import { SignIn as Sign, useClerk } from '@clerk/nextjs'
import Link from 'next/link'

export default function SignInPage() {
  const clerk = useClerk()
  const signUrl = clerk.buildSignInUrl()

  return (
    <div className="grid h-full w-full flex-grow items-center  px-4 sm:justify-center">
      <Sign forceRedirectUrl="/redirect" signUpUrl="/sign-up" />
    </div>
